...
class Movie {
    ...
    public:
        ...
        Movie() {title = ""; review->rating = 0; review->comments = ""; review->next = nullptr;}
};
...
int main() {
    ...
    // Read in data from file to populate objects, then add them to the struct
    ifstream fin;
...
// Everything under this is from Lab 18, not applicable
// ====================================================================
